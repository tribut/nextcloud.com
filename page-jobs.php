	...
	<div class="container">
		...
		<div class="wrapper-text">
            ...
            <div id="accountmgr" class="collapse">
                ...
                <p>The position can be full-time or part-time and working from our Berlin or Stuttgart office as well as from home are possible.</p>
            ...
            <div id="bdr" class="collapse">
                ...
                <ul>
                    <li>Being a first point of contact, qualifying leads by reaching out to prospective customers on phone by mail</li>
                    <li>Engaging prospects pro-actively through various channels</li>
                    <li>Identifying needs of customers and communicating those to marketing, sales and engineering</li>
                    <li>Tracking and managing tasks</li>
                    <li>Initiating initiatives to reach out to prospects</li>
                    <li>Supporting the sales team in a wide array of tasks</li>
                    <li>Identifying and growing opportunities for sales</li>
                </ul>
